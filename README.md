...
| POST | `/api/auth/refresh` | Exchange refresh for new access |
...
| POST | `/api/expenses` | Create (with optional duplicate skip) |
...
| POST | `/api/budgets/generate` | Auto-generate from history |

### Import
| Method | Endpoint | Description |
|--------|----------|-------------|
| POST | `/api/sms/parse` | Parse SMS array → transactions |
| POST | `/api/gmail/fetch` | OAuth fetch + parse emails |
| POST | `/api/ocr/extract` | Image → text → transaction |
...
│   │   │   └── redis.js         # Redis client + caching utils
...
│   │   ├── services/
│   │   │   ├── budget.service.js    # Budget generation logic
│   │   │   ├── sms.service.js       # SMS parsing (regex + LLM)
│   │   │   ├── gmail.service.js     # Gmail OAuth + parsing
│   │   │   ├── chat.service.js      # Rule-based + LLM chat
│   │   │   └── notification.service.js
│   │   ├── utils/
│   │   │   ├── jwt.util.js      # Token generation/verification
│   │   │   ├── llm.util.js      # LLM client factory
│   │   │   └── date.util.js     # Date helper functions
│   │   ├── validator/           # Zod schemas
│   │   └── jobs/
│   │       └── jobScheduler.js  # Cron job definitions
